...
Vagrant.configure("2") do |config|
    ...
    #     mysql.vm.network "public_network", ip: "192.168.0.101"
    ...
    config.vm.define "phpweb" do |phpweb|
        ...
        phpweb.vm.network "public_network", ip: "192.168.0.99"
    ...
    config.vm.define "mysqlserver" do |mysqlserver|
        mysqlserver.vm.network "public_network", ip: "192.168.0.110"

        mysqlserver.vm.provision "shell", inline: "cat /vagrant/configs/id_bionic.pub >> .ssh/authorized_keys"
    end

    config.vm.define "ansible" do |ansible|
        ansible.vm.network "public_network", ip: "192.168.0.111"
